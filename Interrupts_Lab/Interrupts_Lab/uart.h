 ...
 */
FILE*	uart_init(uint8_t, uint32_t, FILE*);
...
/* set this macro to 1 if the code supports buffered transmits handled by interrupts */
/* allows print commands to be called from within interrupt handlers without blocking the ISR */
